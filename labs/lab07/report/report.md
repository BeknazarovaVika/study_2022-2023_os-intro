...
3. Выполним несколько операций в mc, используя управляющие клавиши (рис. @fig:003) (рис. @fig:004) (рис. @fig:005)
...
4. Используя возможности подменю Файл , выполним (рис. @fig:006) (рис. @fig:007) (рис. @fig:008) (рис. @fig:010) 
...
5. С помощью соответствующих средств подменю Команда осуществим (рис. @fig:011)


![ поиск в файловой системе файла с заданными условиями ](image/11.png){#fig:011 width=90%}


6. Задание по встроенному редактору mc (рис. @fig:014) (рис. @fig:015) (рис. @fig:016) (рис. @fig:017) (рис. @fig:018) (рис. @fig:019) (рис. @fig:020) (рис. @fig:021) (рис. @fig:022) (рис. @fig:024)
...
k) Редактировать файл расцветки имён позволяет подобрать оптимальную для пользователя расцветку имён файлов в
