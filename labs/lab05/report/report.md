...
ленным ниже файлам выделенные права доступа, считая, что в начале таких прав (рис. @fig:005)
нет:
(drwxr--r--) australia
( drwx--x--x) play
(-r-xr--r-- ) my_os
...
4. Просмотрим содержимое файла /etc/password (рис. @fig:006)


![файла /etc/password](image/6.png){#fig:006 width=95%}


5. Скопируем файл ~/feathers в файл ~/file.old. Переместим файл ~/file.old в каталог ~/play. Скопируем каталог ~/play в каталог ~/fun. Переместим каталог ~/fun в каталог ~/play и назовем его games. Лишим владельца файла ~/feathers права на чтение..  Дайдим владельцу файла ~/feathers право на чтение.. Лишим владельца каталога ~/play права на выполнение. Перейдите в каталог ~/play. Дайте владельцу каталога ~/play право на выполнение.(рис. @fig:007)


![Работа с файламии правами доступа](image/7.png){#fig:007 width=95%}


6. Прочитаем man по командам mount, fsck, mkfs, kill. (рис. @fig:008) (рис. @fig:009) (рис. @fig:010) (рис. @fig:011)
